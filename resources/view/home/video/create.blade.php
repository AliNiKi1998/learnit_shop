        ...
        <div class="row">
            <div class="col-md-12 col-lg-4 offset-lg-4">
                <div class="base-register shadow-sm">
                    <h3 class="mb-3">ثبت ویدیو جدید</h3>
                    <form action="<?= route('home.course.video.store', ['id' => $id]) ?>" method="post" enctype="multipart/form-data">

                        <div class="form-group">
                            <input type="text" name="name" value="<?= old('name') ?>" class="form-control <?= errorClass('name') ?>" placeholder="اسم ویدیو">
                            <?= errorText('name') ?>
                        </div>
