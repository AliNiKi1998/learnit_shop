        ...
        <div class="row">
            <div class="col-lg-4 offset-lg-4">
                <div class="base-login shadow-sm">
                    ...
                    <form action="<?= route('auth.professor.login') ?>" method="post">
                        <?= errorText('active') ?>
                        <?= errorText('exist') ?>
                        <?= errorText('login') ?>
                        <?= flashText('register') ?>
                        ...
                        <div class="login-footer">
                            ...
                            <span class="float-left"><a href="<?= route('auth.professor.forgot') ?>">رمز عبور را فراموش کرده اید؟</a></span>
                        </div>
                        <div class="btn-login">
                    ...
                    <hr>
                    <p>حساب کاربری ندارید؟ <a href="<?= route('auth.professor.register.view') ?>">ثبت نام کنید</a></p>
                </div>
            </div>
        </div>
    </div>
